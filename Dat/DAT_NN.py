...
def train_model(model, dataloaders, criterion, optimizer, num_epochs=1000, patience=50):
    best_model = None
    best_loss = float('inf')
    no_improvement = 0
...
def main():
    ...
    X = data[["ALTITUDE", "MACH", "ALPHA", "BETA", "DF1", "DF2", "DF3", "DF4"]].values
    y = data[["CD", "CL", "CY", "CM", "CN", "CL_alpha", "CM_alpha", "CN_beta"]].values
    ...
    # Exemplo de previsão
    input_data = [[10000, 0.8, 5, 0, 0, 0, 0, 0]]  # Exemplo de entrada
