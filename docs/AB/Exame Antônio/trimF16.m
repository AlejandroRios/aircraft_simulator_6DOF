...
%x = [u v w p q r phi theta psi power | throttle de da dr]';                                           %Incógnitas
...
C_tv                    = Cmat(2,trim_par.gamma_deg*pi/180)*Cmat(3,trim_par.chi_deg*pi/180);    %Matriz de rotação para trajetória 
V_i                     = C_tv.'*[trim_par.V; 0; 0];                                            %Velocidade no sistema da trajetória
