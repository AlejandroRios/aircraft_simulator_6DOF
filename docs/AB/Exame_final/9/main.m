...
% print(fig1,'Ex_9_3','-dpdf','-r0')
%%
[Y,T,X] = initial(sys,20);
...
% figure(3)
% subplot(2,1,1)
% plot(CG(3),zeta,'ok','linewidth',2)
% xlabel('Conf CG')
% ylabel('Amortecimento')
% grid on
% hold all
% subplot(2,1,2)
% plot(CG(3),Wn,'ok','linewidth',2)
% xlabel('Conf CG')
